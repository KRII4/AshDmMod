...
import net.mcreator.scorcheddimension.fluid.AshwaterFluid;
import net.mcreator.scorcheddimension.ScorcheddimensionMod;

public class ScorcheddimensionModFluids {
	public static final DeferredRegister<Fluid> REGISTRY = DeferredRegister.create(ForgeRegistries.FLUIDS, ScorcheddimensionMod.MODID);
