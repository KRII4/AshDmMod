...
public class ScorcheddimensionModEntities {
	...
	public static final RegistryObject<EntityType<QuaddyEntity>> QUADDY = register("quaddy", EntityType.Builder.<QuaddyEntity>of(QuaddyEntity::new, MobCategory.MONSTER).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3)
			.setCustomClientFactory(QuaddyEntity::new).fireImmune().sized(0.8f, 0.7000000000000001f));
	...
	public static final RegistryObject<EntityType<ShechelEntity>> SHECHEL = register("shechel",
			EntityType.Builder.<ShechelEntity>of(ShechelEntity::new, MobCategory.MONSTER).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(ShechelEntity::new).fireImmune().sized(0.6f, 1.8f));
	public static final RegistryObject<EntityType<GeckoashEntity>> GECKOASH = register("geckoash",
			EntityType.Builder.<GeckoashEntity>of(GeckoashEntity::new, MobCategory.MONSTER).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(GeckoashEntity::new)
	...
	public static void registerAttributes(EntityAttributeCreationEvent event) {
		...
		event.put(SHECHEL.get(), ShechelEntity.createAttributes().build());
		event.put(GECKOASH.get(), GeckoashEntity.createAttributes().build());
	}
}
