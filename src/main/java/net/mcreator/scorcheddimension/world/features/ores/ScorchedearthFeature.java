...
public class ScorchedearthFeature extends OreFeature {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("scorcheddimension:scorchedearth", FEATURE,
				new OreConfiguration(List.of(OreConfiguration.target(new BlockStateMatchTest(ScorcheddimensionModBlocks.ASH_ROCK.get().defaultBlockState()), ScorcheddimensionModBlocks.SCORCHEDEARTH.get().defaultBlockState())), 16));
		PLACED_FEATURE = PlacementUtils.register("scorcheddimension:scorchedearth", CONFIGURED_FEATURE,
