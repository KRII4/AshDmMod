...
public class ElementalPicaxeItem extends PickaxeItem {
	public ElementalPicaxeItem() {
		super(new Tier() {
			public int getUses() {
				return 1760;
			}
		...
		}, 1, -2.8f, new Item.Properties().tab(ScorcheddimensionModTabs.TAB_SCORCHED_BIOME).fireResistant());
	}
