...
public class AshenSkeletonEntity extends Monster implements IAnimatable {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(AshenSkeletonEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(AshenSkeletonEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(AshenSkeletonEntity.class, EntityDataSerializers.STRING);
	...
	public AshenSkeletonEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ScorcheddimensionModEntities.ASHEN_SKELETON.get(), world);
	}

	public AshenSkeletonEntity(EntityType<AshenSkeletonEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "ashskeletontexture");
	}
	...
	public static void init() {
		SpawnPlacements.register(ScorcheddimensionModEntities.ASHEN_SKELETON.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(AshenSkeletonEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
