...
public class AshenSoulEntity extends Monster implements IAnimatable {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(AshenSoulEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(AshenSoulEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(AshenSoulEntity.class, EntityDataSerializers.STRING);
	...
	public AshenSoulEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ScorcheddimensionModEntities.ASHEN_SOUL.get(), world);
	}

	public AshenSoulEntity(EntityType<AshenSoulEntity> type, Level world) {
		super(type, world);
		xpReward = 9;
		setNoAi(false);
	}
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "ashsoultexture");
	}
	...
	public static void init() {
		SpawnPlacements.register(ScorcheddimensionModEntities.ASHEN_SOUL.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
				(entityType, world, reason, pos, random) -> (world.getDifficulty() != Difficulty.PEACEFUL && Monster.isDarkEnoughToSpawn(world, pos, random) && Mob.checkMobSpawnRules(entityType, world, reason, pos, random)));
		DungeonHooks.addDungeonMob(ScorcheddimensionModEntities.ASHEN_SOUL.get(), 180);
	}
	...
	public static AttributeSupplier.Builder createAttributes() {
		...
		builder = builder.add(Attributes.ARMOR, 2.4);
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 26) {
			this.remove(AshenSoulEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
