...
public class GhostModel extends AnimatedGeoModel<GhostEntity> {
	...
	public ResourceLocation getAnimationResource(GhostEntity entity) {
		return new ResourceLocation("scorcheddimension", "animations/animghost.animation.json");
	}

	@Override
	public ResourceLocation getModelResource(GhostEntity entity) {
		return new ResourceLocation("scorcheddimension", "geo/animghost.geo.json");
	}
	...
	@Override
	public void setCustomAnimations(GhostEntity animatable, int instanceId, AnimationEvent animationEvent) {
