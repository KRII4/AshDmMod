...
public class BiomesplsModEntities {
	...
	public static final RegistryObject<EntityType<AshenSlimeEntity>> ASHEN_SLIME = register("ashen_slime", EntityType.Builder.<AshenSlimeEntity>of(AshenSlimeEntity::new, MobCategory.MONSTER).setShouldReceiveVelocityUpdates(true).setTrackingRange(64)
			.setUpdateInterval(3).setCustomClientFactory(AshenSlimeEntity::new).fireImmune().sized(0.4f, 0.4f));
	...
	public static void registerAttributes(EntityAttributeCreationEvent event) {
		...
		event.put(ASHEN_SLIME.get(), AshenSlimeEntity.createAttributes().build());
