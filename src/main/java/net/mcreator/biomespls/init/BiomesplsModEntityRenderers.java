...
public class BiomesplsModEntityRenderers {
	...
	public static void registerEntityRenderers(EntityRenderersEvent.RegisterRenderers event) {
		...
		event.registerEntityRenderer(BiomesplsModEntities.ASH_SLIME.get(), AshSlimeRenderer::new);
		event.registerEntityRenderer(BiomesplsModEntities.VOID_SPEAR.get(), ThrownItemRenderer::new);
	}
}
