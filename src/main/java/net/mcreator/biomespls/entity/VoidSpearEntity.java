...
import net.mcreator.biomespls.procedures.VoidSpearProjectileHitsLivingEntityProcedure;
import net.mcreator.biomespls.procedures.VoidSpearProjectileHitsBlockProcedure;
...
public class VoidSpearEntity extends AbstractArrow implements ItemSupplier {
	public VoidSpearEntity(PlayMessages.SpawnEntity packet, Level world) {
		super(BiomesplsModEntities.VOID_SPEAR.get(), world);
	}
	...
	public ItemStack getItem() {
		return new ItemStack(BiomesplsModItems.VOID_SPEAR.get());
	}
	...
	public static VoidSpearEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		VoidSpearEntity entityarrow = new VoidSpearEntity(BiomesplsModEntities.VOID_SPEAR.get(), entity, world);
	...
	public static VoidSpearEntity shoot(LivingEntity entity, LivingEntity target) {
		VoidSpearEntity entityarrow = new VoidSpearEntity(BiomesplsModEntities.VOID_SPEAR.get(), entity, entity.level);
