...
import net.mcreator.biomespls.procedures.GhostOnEntityTickUpdateProcedure;
...
public class GhostEntity extends Monster implements IAnimatable {
	...
	public GhostEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(BiomesplsModEntities.GHOST.get(), world);
	}
	...
	public void baseTick() {
		super.baseTick();
		GhostOnEntityTickUpdateProcedure.execute(this.level, this.getX(), this.getY(), this.getZ());
