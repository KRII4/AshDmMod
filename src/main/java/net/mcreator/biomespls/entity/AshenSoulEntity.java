...
public class AshenSoulEntity extends Monster implements IAnimatable {
	...
	public AshenSoulEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(BiomesplsModEntities.ASHEN_SOUL.get(), world);
	}
	...
	public static void init() {
		SpawnPlacements.register(BiomesplsModEntities.ASHEN_SOUL.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
				(entityType, world, reason, pos, random) -> (world.getDifficulty() != Difficulty.PEACEFUL && Monster.isDarkEnoughToSpawn(world, pos, random) && Mob.checkMobSpawnRules(entityType, world, reason, pos, random)));
		DungeonHooks.addDungeonMob(BiomesplsModEntities.ASHEN_SOUL.get(), 180);
	}
